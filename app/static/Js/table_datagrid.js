        ...
        $(_o.datagridId).datagrid({
            ...
            onLoadSuccess: function (data) {
                if (data.rows.length != 0) {
                    var _filter = $(_o.datagridId).data("filterObj");
                    var _total = _filter.filterFeildData;
    ...
    _o.load_data = function (url) {
        $.ajax({
            ...
            success: function (data) {
                ...
                var _data = {total: data.length, rows: data, footer: [{id: '汇总'}]}
